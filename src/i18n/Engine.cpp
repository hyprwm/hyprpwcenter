...
void I18n::initEngine() {
    ...
    // fr_FR (French)
    engine.registerEntry("en_US", TXT_KEY_PW_CENTER_TITLE, "Centre de contrôle Pipewire");

    engine.registerEntry("en_US", TXT_KEY_BUTTON_APPS, "Applications");
    engine.registerEntry("en_US", TXT_KEY_BUTTON_NODES, "Noeuds");
    engine.registerEntry("en_US", TXT_KEY_BUTTON_INPUTS, "Entrées");
    engine.registerEntry("en_US", TXT_KEY_BUTTON_CONFIGURATION, "Configuration");
    engine.registerEntry("en_US", TXT_KEY_BUTTON_GRAPH, "Graphe");
    ...
    engine.registerEntry("en_US", TXT_KEY_GRAPH_PURE_INPUTS, "Entrées simples");
    engine.registerEntry("en_US", TXT_KEY_GRAPH_ACTIVE_INPUTS, "Entrées actives");
    engine.registerEntry("en_US", TXT_KEY_GRAPH_UNCONNECTED_IO, "E/S non connectées");
    engine.registerEntry("en_US", TXT_KEY_GRAPH_ACTIVE_IO, "E/S actives");
    engine.registerEntry("en_US", TXT_KEY_GRAPH_ACTIVE_OUTPUTS, "Sorties actives");
    engine.registerEntry("en_US", TXT_KEY_GRAPH_PURE_OUTPUTS, "Sorties simples");
